...
namespace CRM.WebUI.Data
{
    ...
    [Migration("20170414090207_full2")]
    partial class full2
    {
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Activity", b =>
                {
                    ...
                    b.Property<int?>("AttendStudentCustomerID1");
                    ...
                    b.HasIndex("AttendStudentCustomerID1");
            ...
            modelBuilder.Entity("CRM.Domain.Entities.VisaApplication", b =>
                {
                    ...
                    b.Property<int?>("InstituteIDAccountID");
                    ...
                    b.HasIndex("InstituteIDAccountID");
            ...
            modelBuilder.Entity("CRM.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasOne("CRM.Domain.Entities.Student", "AttendStudent")
                        .WithMany()
                        .HasForeignKey("AttendStudentCustomerID1");

                    b.HasOne("CRM.Domain.Entities.Customer")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("CRM.Domain.Entities.VisaApplication", b =>
                {
                    ...
                    b.HasOne("CRM.Domain.Entities.Account", "InstituteID")
                        .WithMany()
                        .HasForeignKey("InstituteIDAccountID");
